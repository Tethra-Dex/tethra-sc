...
contract PositionManagerTest is Test {
    ...
    function testCreatePosition_MultiplePositions() public {
        ...
        uint256 positionId1 = positionManager.createPosition(
            trader1,
            SYMBOL_BTC,
            true,
            COLLATERAL,
        ...
        uint256 positionId2 = positionManager.createPosition(
            trader1,
            "ETH",
            false,
            2000e6,
    ...
    function testGetPositionStatus() public {
        ...
        assertEq(
            uint256(positionManager.getPositionStatus(positionId)),
            uint256(PositionManager.PositionStatus.OPEN)
        );
        ...
        assertEq(
            uint256(positionManager.getPositionStatus(positionId)),
            uint256(PositionManager.PositionStatus.CLOSED)
        );
    ...
    function testFuzz_CreatePosition(
        uint256 collateral,
        uint256 leverage,
        uint256 entryPrice
    ) public {
